...
var I18N = {
  ...
  // AI Chat page
  'ai-title':       {en:'AI Scam Detector', ar:'كاشف الاحتيال بالذكاء الاصطناعي'},
  'ai-subtitle':    {en:'Chat with our AI to analyze suspicious messages, links, and emails. Ask follow-up questions to learn more.', ar:'تحدث مع الذكاء الاصطناعي لتحليل الرسائل والروابط والإيميلات المشبوهة. اسأل أسئلة متابعة لمعرفة المزيد.'},
  'chat-placeholder':{en:'Paste a suspicious message or ask about a scam...', ar:'الصق رسالة مشبوهة أو اسأل عن نصبة...'},
  'chat-send':      {en:'Send', ar:'إرسال'},
  'chat-thinking':  {en:'Analyzing...', ar:'جاري التحليل...'},
  'chat-welcome':   {en:'Hello! I\'m your AI scam detection assistant. I can help you:', ar:'مرحباً! أنا مساعدك الذكي لكشف الاحتيال. أقدر أساعدك في:'},
  'chat-w1':        {en:'Analyze suspicious messages, SMS, or emails', ar:'تحليل الرسائل المشبوهة أو SMS أو الإيميلات'},
  'chat-w2':        {en:'Check if a link or website is a scam', ar:'فحص إذا كان رابط أو موقع نصبة'},
  'chat-w3':        {en:'Explain how common scams work in Kuwait', ar:'شرح كيف تعمل النصبات الشائعة في الكويت'},
  'chat-w4':        {en:'Give you tips to protect yourself', ar:'نصائح لحماية نفسك'},
  'chat-apikey-needed':{en:'To use the AI chatbot, you need a free Gemini API key.', ar:'لاستخدام الشات بوت، تحتاج مفتاح Gemini API مجاني.'},
  'chat-get-key':   {en:'Get Free API Key', ar:'احصل على مفتاح مجاني'},
  'chat-save-key':  {en:'Save Key', ar:'حفظ المفتاح'},
  'chat-key-placeholder':{en:'Paste your Gemini API key here...', ar:'الصق مفتاح Gemini API هنا...'},
  'chat-key-saved': {en:'API key saved!', ar:'تم حفظ المفتاح!'},
  'chat-key-invalid':{en:'Please enter a valid API key.', ar:'الرجاء إدخال مفتاح صالح.'},
  'chat-error':     {en:'Something went wrong. Please try again.', ar:'حدث خطأ. حاول مجدداً.'},
  'chat-rate-limit':{en:'Rate limit reached. Please wait a moment and try again.', ar:'تم تجاوز الحد. انتظر لحظة وحاول مجدداً.'},
  'chat-clear':     {en:'Clear Chat', ar:'مسح المحادثة'},
  'chat-ex-civil':  {en:'Check this: "Your civil ID has expired, renew immediately at http://moi-kw.info/renew"', ar:'افحص هذا: "بطاقتك المدنية انتهت، جدد فوراً على http://moi-kw.info/renew"'},
  'chat-ex-invest': {en:'Is this legit? "Double your money in 30 days! Guaranteed 40% monthly returns with TradeKW"', ar:'هل هذا حقيقي؟ "ضاعف أموالك خلال 30 يوم! عوائد مضمونة 40% شهرياً مع TradeKW"'},
  'chat-ex-otp':    {en:'Someone called saying they\'re from NBK and need my OTP to secure my account. Is this real?', ar:'شخص اتصل يقول إنه من بنك الكويت الوطني ويحتاج رمز OTP لتأمين حسابي. هل هذا حقيقي؟'},
  'chat-ex-delivery':{en:'I got an SMS: "Your Aramex package is held at customs. Pay 2.5 KD processing fee to release: http://aramex-kw-delivery.com/pay"', ar:'وصلني SMS: "طردك من Aramex موقوف بالجمارك. ادفع 2.5 دينار رسوم معالجة: http://aramex-kw-delivery.com/pay"'},
  'chat-ex-whatsapp':{en:'Got a WhatsApp message: "Congratulations! You won a KWD 5,000 gift card from The Avenues Mall. Claim now: http://avenues-gift.win/claim"', ar:'وصلني واتساب: "مبروك! ربحت بطاقة هدية 5,000 دينار من الأفنيوز. استلم الآن: http://avenues-gift.win/claim"'},
  'chat-online':    {en:'Online', ar:'متصل'},
  'stat-ai':        {en:'AI-Powered', ar:'ذكاء اصطناعي'},
  'stat-bilingual': {en:'Arabic & English', ar:'عربي وإنجليزي'},
  'stat-kuwait':    {en:'Kuwait Focus', ar:'خاص بالكويت'},
  // Simulator
  ...
  // Email Breach
  'tab-breach':     {en:'Email Breach', ar:'تسريب الإيميل'},
  'breach-title':   {en:'Have I Been Pwned?', ar:'هل تم اختراق إيميلي؟'},
  'breach-sub':     {en:'Check if your email address has appeared in any known data breaches.', ar:'تحقق إذا ظهر إيميلك في أي تسريب بيانات معروف.'},
  'breach-scan':    {en:'Check', ar:'فحص'},
  'breach-privacy': {en:'Your email is checked securely. We do not store or log any data.', ar:'يتم فحص إيميلك بأمان. لا نخزّن أو نسجّل أي بيانات.'},
  'breach-stat-sites':    {en:'Breached Sites', ar:'مواقع مخترقة'},
  'breach-stat-accounts': {en:'Compromised Accounts', ar:'حسابات مسرّبة'},
  'breach-stat-pastes':   {en:'Paste Sources', ar:'مصادر لصق'},
  // About
  ...
  'about-f2-title': {en:'AI Scam Detector', ar:'كاشف النصب بالذكاء الاصطناعي'},
  'about-f2-desc':  {en:'Chat with an AI-powered assistant that analyzes suspicious messages, scans URLs, searches for known scams, and explains how fraud works — with Kuwait-specific context.', ar:'تحدث مع مساعد ذكاء اصطناعي يحلل الرسائل المشبوهة ويفحص الروابط ويبحث عن النصبات المعروفة ويشرح كيف يعمل الاحتيال — بسياق كويتي.'},
  ...
  'about-f7-title': {en:'Password Strength Checker', ar:'فاحص قوة كلمة المرور'},
  'about-f7-desc':  {en:'13-point password analysis with Have I Been Pwned breach database integration. 100% client-side — your password never leaves your browser.', ar:'تحليل كلمة مرور من 13 نقطة مع دمج قاعدة بيانات تسريبات Have I Been Pwned. 100% محلي — كلمة مرورك لا تغادر متصفحك أبداً.'},
  'about-f8-title': {en:'Link & URL Scanner', ar:'فاحص الروابط والعناوين'},
  'about-f8-desc':  {en:'Multi-API URL scanner using VirusTotal, Google Safe Browsing, URLScan.io, PhishTank, and IPQualityScore for comprehensive threat detection.', ar:'فاحص روابط متعدد الـ APIs يستخدم VirusTotal وGoogle Safe Browsing وURLScan.io وPhishTank وIPQualityScore للكشف الشامل عن التهديدات.'},
  'about-api-vt':   {en:'Scans URLs against 70+ security engines including Kaspersky, BitDefender, and ESET.', ar:'يفحص الروابط ضد 70+ محرك أمني بما في ذلك Kaspersky وBitDefender وESET.'},
  'about-api-gsb':  {en:'Detects malware, social engineering, unwanted software, and harmful applications.', ar:'يكشف البرامج الخبيثة والهندسة الاجتماعية والبرامج غير المرغوبة والتطبيقات الضارة.'},
  'about-api-pt':   {en:'Community-driven phishing verification database — no API key required.', ar:'قاعدة بيانات تحقق تصيد مجتمعية — لا يحتاج مفتاح API.'},
  'about-api-ipqs': {en:'Advanced fraud scoring with phishing, malware, and domain age analysis.', ar:'تسجيل احتيال متقدم مع تحليل التصيد والبرامج الخبيثة وعمر النطاق.'},
  'about-api-urlscan': {en:'Website scanning and threat intelligence — works without API key.', ar:'فحص المواقع واستخبارات التهديدات — يعمل بدون مفتاح API.'},
  'about-api-hibp': {en:'K-anonymity password breach check against 10+ billion compromised passwords.', ar:'فحص تسريب كلمات المرور بخصوصية K-anonymity ضد 10+ مليار كلمة مرور مخترقة.'},
  'about-api-abuse': {en:'IP reputation database for identifying malicious infrastructure.', ar:'قاعدة بيانات سمعة IP لتحديد البنية التحتية الخبيثة.'},
  ...
  'level-safe':      {en:'LOW RISK — Verify Independently',  ar:'خطر منخفض — تحقق بشكل مستقل'},
...
var GEMINI_SYSTEM_PROMPT = [
  'You are ShieldKW AI — a cybersecurity scam detection assistant specialized in Kuwait.',
  'Your job is to analyze suspicious messages, SMS, emails, links, and phone calls that users paste or describe.',
  '',
  'When a user sends you a message to analyze:',
  '1. Determine if it is a SCAM, SUSPICIOUS, or LEGITIMATE.',
  '2. Start your response with a verdict line: 🚨 SCAM DETECTED, ⚠️ SUSPICIOUS, or ✅ LIKELY LEGITIMATE.',
  '3. Explain WHY — list the specific red flags or signs of legitimacy.',
  '4. If there are URLs, analyze the domain (e.g. .info vs .gov.kw), look for typosquatting, suspicious TLDs.',
  '5. Explain how this type of scam works in general.',
  '6. Give actionable advice on what the user should do.',
  '7. If relevant, mention Kuwait-specific context (MOI, PACI, NBK, KFH, CBK, Zain, Ooredoo, STC, KNET, etc.).',
  '8. Mention the Kuwait Cybercrime Unit hotline: 1872 for reporting.',
  '',
  'Important rules:',
  '- Respond in the SAME language the user writes in. If they write Arabic, respond in Arabic (Kuwaiti dialect is fine).',
  '- Be concise but thorough. Use bullet points for red flags.',
  '- Never ask for personal information, passwords, or OTPs.',
  '- If the user asks general questions about scams or cybersecurity, answer helpfully.',
  '- Format your response with clear sections using bold text for emphasis.',
  '- If you are not sure, say so and recommend caution.',
...
function updateScanCounter() {
  ...
  if (el) el.textContent = _chatScanCount;
}
...
function renderWelcomeMessage() {
  ...
  welcome.innerHTML =
    '<div class="chat-welcome-title">🛡️ ' + t('chat-welcome') + '</div>' +
    '<ul>' +
      '<li>' + t('chat-w1') + '</li>' +
      '<li>' + t('chat-w2') + '</li>' +
      '<li>' + t('chat-w3') + '</li>' +
      '<li>' + t('chat-w4') + '</li>' +
    '</ul>' +
    '<div style="margin-top:10px;font-size:0.62rem;color:var(--muted);font-family:monospace;display:flex;align-items:center;gap:6px;">' +
      '<span style="color:var(--green)">●</span> ' +
      (LANG === 'ar' ? 'الذكاء الاصطناعي جاهز — الصق رسالة أو اختر مثال بالأسفل' : 'AI ready — paste a message or tap an example below') +
    '</div>';
...
function addChatBubble(role, html) {
  ...
  if (role === 'bot') {
    ...
    bubble.innerHTML = '<span class="bubble-label">ShieldKW AI</span><span class="bubble-content">' + html + '</span>' +
      '<button class="bubble-copy-btn" onclick="copyBubble(this)">📋 ' + (LANG==='ar'?'نسخ':'Copy') + '</button>';
  } else {
...
function copyBubble(btn) {
  ...
  navigator.clipboard.writeText(text).then(function(){
    ...
    setTimeout(function(){ btn.innerHTML = '📋 ' + (LANG==='ar'?'نسخ':'Copy'); }, 1500);
  }).catch(function(){});
}
...
async function callGeminiAPI(userMessage) {
  ...
  var fullContents = [
    ...
    { role: 'model', parts: [{ text: 'Understood. I am ShieldKW AI, ready to analyze messages for scams. Send me anything suspicious.' }] }
  ];
  ...
  for (var m = 0; m < models.length; m++) {
    try {
      resp = await fetch(
        'https://generativelanguage.googleapis.com/v1beta/models/' + models[m] + ':generateContent?key=' + _geminiKey,
        {
          method: 'POST',
      ...
      if (resp.status === 404 || errMsg.indexOf('not found') >= 0 || errMsg.indexOf('not supported') >= 0) {
        lastErr = 'MODEL_NOT_FOUND'; resp = null; continue;
      }
      if (resp.status === 429) { lastErr = 'RATE_LIMIT'; resp = null; break; }
      lastErr = 'API_ERROR: ' + (errMsg || resp.status);
      resp = null; break;
    } catch(fetchErr) {
      lastErr = 'NETWORK_ERROR'; resp = null; break;
    }
  }
...
async function sendChatMessage() {
  ...
  try {
    ...
    if (e.message === 'RATE_LIMIT') errMsg = t('chat-rate-limit');
    else if (e.message === 'NETWORK_ERROR') errMsg = LANG==='ar'?'خطأ في الاتصال. تحقق من الإنترنت.':'Network error. Check your connection.';
    else if (e.message && e.message.indexOf('API_ERROR') === 0) errMsg = LANG==='ar'?'حدث خطأ. حاول مرة أخرى.':'Something went wrong. Please try again.';
  ...
  if (!opts.method || opts.method === 'GET') {
    for (var i = 0; i < CORS_PROXIES.length; i++) {
      ...
      try {
        ...
        var resp2 = await fetch(proxyUrl, { headers: opts.headers || {} });
        if (resp2.ok || resp2.status === 404) { _activeProxy = idx; return resp2; }
...
var SCENARIOS=[
  ...
  },
  {
    ...
    category:{en:'Telecom', ar:'اتصالات'}, difficulty:'medium'
  },
  // ─── NEW SCENARIOS ───────────────────────────────────────────
  {
    from:{en:'SMS: KNET-Alert',ar:'SMS: KNET-Alert'},
    subject:{en:'',ar:''},
    body:{en:'KNET Payment Alert:\nA payment of <strong>KWD 85.000</strong> was charged from your card ending 4872.\n\nIf you did NOT authorize this, cancel immediately:\n<span class="scenario-link">https://knet-dispute.info/cancel?ref=KW48291</span>\n\nKNET Kuwait — Your Trusted Payment Network',ar:'تنبيه دفع KNET:\nتم خصم <strong>85.000 دينار</strong> من بطاقتك المنتهية بـ 4872.\n\nإذا لم تُفوّض هذه العملية، ألغِها فوراً:\n<span class="scenario-link">https://knet-dispute.info/cancel?ref=KW48291</span>\n\nKNET الكويت — شبكة دفع موثوقة'},
    q:{en:'What should you do when you receive this message?',ar:'ماذا تفعل عند استلام هذه الرسالة؟'},
    opts:[{en:'Click the link immediately — KWD 85 is at risk',ar:'اضغط الرابط فوراً — 85 دينار في خطر'},{en:'Call your bank directly using the number on your card',ar:'اتصل ببنكك مباشرة على الرقم الموجود في بطاقتك'},{en:'Reply STOP to the message',ar:'رد بكلمة STOP على الرسالة'},{en:'Forward to your friends to warn them',ar:'أرسلها لأصدقائك لتحذيرهم'}],
    correct:1,
    feedback:{en:'✅ <strong>Correct!</strong> KNET never sends dispute cancellation links via SMS. If you see an unauthorized charge, call your bank directly using the number on the back of your card or visit a branch. The domain knet-dispute.info is fake — the real KNET website is knet.com.kw. Fake urgency about money being "stolen" is a classic social engineering trick.',ar:'✅ <strong>صح!</strong> KNET لا ترسل روابط إلغاء خلافات عبر SMS. إذا رأيت خصم غير مصرح، اتصل ببنكك مباشرة على الرقم في ظهر بطاقتك أو زر فرع. النطاق knet-dispute.info مزيف — موقع KNET الحقيقي هو knet.com.kw. الاستعجال الوهمي حول سرقة أموالك هو حيلة هندسة اجتماعية كلاسيكية.'},
    category:{en:'Banking', ar:'بنوك'}, difficulty:'medium'
  },
  {
    from:{en:'Instagram DM: @official.instagram.kw',ar:'إنستغرام: @official.instagram.kw'},
    subject:{en:'',ar:''},
    body:{en:'📢 <strong>Instagram Kuwait Verification Program</strong>\n\nCongratulations! Your account has been selected for a <strong>blue verification badge ✓</strong>\n\nTo complete verification, we need to confirm your identity:\n\n1. Your Instagram username & password\n2. A selfie with your Civil ID\n3. Your phone number\n\nSubmit here: <span class="scenario-link">https://instagram-verify-kw.com/badge</span>\n\n⚠️ Offer expires in 48 hours',ar:'📢 <strong>برنامج التحقق الكويتي من إنستغرام</strong>\n\nمبروك! تم اختيار حسابك للحصول على <strong>شارة التحقق الزرقاء ✓</strong>\n\nلإتمام التحقق نحتاج تأكيد هويتك:\n\n1. اسم مستخدم وكلمة مرور إنستغرام\n2. سيلفي مع بطاقتك المدنية\n3. رقم هاتفك\n\nأرسل هنا: <span class="scenario-link">https://instagram-verify-kw.com/badge</span>\n\n⚠️ العرض ينتهي خلال 48 ساعة'},
    q:{en:'This message asks for your Instagram password and Civil ID. What is this?',ar:'هذه الرسالة تطلب كلمة مرور إنستغرام وبطاقتك المدنية. ما هذا؟'},
    opts:[{en:'A real Instagram program — Meta does this in Kuwait',ar:'برنامج إنستغرام حقيقي — ميتا تفعل هذا بالكويت'},{en:'Account takeover + identity theft combo attack',ar:'هجوم مزدوج: سرقة حساب + سرقة هوية'},{en:'A phishing attempt for your Instagram only',ar:'محاولة تصيّد لحسابك على إنستغرام فقط'},{en:'A fake badge scam — but harmless if you don\'t pay',ar:'احتيال شارة مزيفة — لكن غير ضار إذا لم تدفع'}],
    correct:1,
    feedback:{en:'🚨 <strong>Extremely dangerous!</strong> This scam has two devastating goals: (1) Your Instagram password → they take over your account and scam your followers. (2) Your selfie with Civil ID → identity theft that can be used to take loans, open bank accounts, or commit crimes in your name. Instagram NEVER asks for your password or government ID via DM. Verification requests always come from inside the Instagram app itself.',ar:'🚨 <strong>خطير للغاية!</strong> هذا الاحتيال له هدفان مدمّران: (1) كلمة مرور إنستغرام → يستولون على حسابك وينصبون على متابعيك. (2) سيلفي مع البطاقة المدنية → سرقة هوية يمكن استخدامها لأخذ قروض وفتح حسابات بنكية أو ارتكاب جرائم باسمك. إنستغرام لا يطلب أبداً كلمة مرورك أو هويتك عبر رسائل مباشرة. طلبات التحقق تأتي دائماً من داخل تطبيق إنستغرام نفسه.'},
    category:{en:'Social Media', ar:'سوشال ميديا'}, difficulty:'hard'
  },
  {
    from:{en:'WhatsApp: +965 9XXX XXXX (saved as "Zain Kuwait")',ar:'واتساب: +965 9XXX XXXX (محفوظ كـ "زين الكويت")'},
    subject:{en:'',ar:''},
    body:{en:'🎁 <strong>Zain Kuwait — Exclusive Loyalty Reward!</strong>\n\nDear customer, you have been selected for our <strong>30GB free data bundle</strong> — valid for 90 days!\n\nActivate your free bundle now:\n<span class="scenario-link">https://zain-kw-offers.net/free-30gb</span>\n\nThis offer was sent to only 500 lucky Zain customers. Act fast! ⏰',ar:'🎁 <strong>زين الكويت — مكافأة ولاء حصرية!</strong>\n\nعزيزي العميل، تم اختيارك لـ <strong>باقة 30 جيجا مجانية</strong> — صالحة 90 يوم!\n\nفعّل باقتك المجانية الآن:\n<span class="scenario-link">https://zain-kw-offers.net/free-30gb</span>\n\nهذا العرض أُرسل لـ 500 عميل زين محظوظ فقط. تصرّف بسرعة! ⏰'},
    q:{en:'Your contact list shows this as "Zain Kuwait". Should you trust it?',ar:'قائمة جهات اتصالك تظهرها كـ "زين الكويت". هل تثق بها؟'},
    opts:[{en:'Yes — it\'s saved as Zain Kuwait so it must be real',ar:'نعم — محفوظة كـ "زين الكويت" إذن هي حقيقية'},{en:'No — anyone can save a number with any name; the domain is not zain.com.kw',ar:'لا — أي شخص يقدر يحفظ رقم بأي اسم؛ والنطاق ليس zain.com.kw'},{en:'Only if the 30GB offer actually works after clicking',ar:'فقط إذا باقة الـ 30 جيجا اشتغلت بعد الضغط'},{en:'Call Zain 107 first to verify the offer',ar:'اتصل على 107 أولاً لتتحقق من العرض'}],
    correct:1,
    feedback:{en:'✅ <strong>Correct!</strong> A name in your contact list means nothing — you (or anyone who had your phone) could have saved any number under any name. The domain zain-kw-offers.net is not Zain\'s official domain (zain.com.kw). Telecom companies like Zain, Ooredoo, and STC never send bundle activation links via WhatsApp. If you want to check real offers, use the official MyZain app.',ar:'✅ <strong>صح!</strong> الاسم في قائمة الاتصال لا يعني شيئاً — أنت (أو أي شخص عنده هاتفك) كان ممكن يحفظ أي رقم بأي اسم. النطاق zain-kw-offers.net ليس النطاق الرسمي لزين (zain.com.kw). شركات الاتصالات مثل زين وأوريدو وSTC لا ترسل روابط تفعيل باقات عبر واتساب. إذا أردت التحقق من عروض حقيقية، استخدم تطبيق MyZain الرسمي.'},
    category:{en:'Telecom', ar:'اتصالات'}, difficulty:'easy'
  },
  {
    from:{en:'Email: noreply@nbk-alert.com',ar:'إيميل: noreply@nbk-alert.com'},
    subject:{en:'⚠️ Action Required: Verify Your NBK Account',ar:'⚠️ مطلوب: تحقق من حساب NBK الخاص بك'},
    body:{en:'Dear NBK Customer,\n\nWe have detected <strong>unusual login activity</strong> on your account from an unrecognized device.\n\nFor your security, your account has been <strong>temporarily limited</strong>.\n\nTo restore full access, verify your identity:\n<span class="scenario-link">https://nbk-alert.com/verify/secure-login</span>\n\nFailure to verify within 12 hours will result in permanent account suspension.\n\nNBK Security Team',ar:'عزيزي عميل NBK،\n\nرصدنا <strong>نشاطاً غير عادي</strong> على حسابك من جهاز غير معروف.\n\nلأمانك، تم <strong>تقييد حسابك مؤقتاً</strong>.\n\nلاستعادة الوصول الكامل، تحقق من هويتك:\n<span class="scenario-link">https://nbk-alert.com/verify/secure-login</span>\n\nعدم التحقق خلال 12 ساعة سيؤدي إلى تعليق دائم للحساب.\n\nفريق أمن NBK'},
    q:{en:'The sender email domain is nbk-alert.com. What does this tell you?',ar:'نطاق إيميل المُرسل هو nbk-alert.com. ماذا يخبرك هذا؟'},
    opts:[{en:'It\'s legitimate — "alert" makes sense for a security notification',ar:'شرعية — "alert" منطقي لإشعار أمني'},{en:'It\'s fake — NBK\'s real email domain is nbk.com, not nbk-alert.com',ar:'مزيفة — نطاق إيميل NBK الحقيقي هو nbk.com وليس nbk-alert.com'},{en:'Uncertain — better to click and check',ar:'غير مؤكد — أفضل أضغط وأتحقق'},{en:'Only suspicious because of the 12-hour threat',ar:'مشبوهة فقط بسبب التهديد بـ 12 ساعة'}],
    correct:1,
    feedback:{en:'✅ <strong>Correct!</strong> The email domain is the #1 thing to check. NBK\'s official email domain is @nbk.com — not @nbk-alert.com, @nbk-secure.com, or any variation. Scammers buy domains that look similar to the real thing. Also notice: the "permanent suspension" threat is a pressure tactic, and real banks never threaten permanent suspension without prior official notice.',ar:'✅ <strong>صح!</strong> نطاق الإيميل هو أول شيء تتحقق منه. نطاق إيميل NBK الرسمي هو @nbk.com — وليس @nbk-alert.com أو @nbk-secure.com أو أي تنويع. المحتالون يشترون نطاقات تبدو مشابهة للنطاق الحقيقي. لاحظ أيضاً: التهديد بـ"التعليق الدائم" هو أسلوب ضغط، والبنوك الحقيقية لا تهدد بالتعليق الدائم بدون إشعار رسمي مسبق.'},
    category:{en:'Banking', ar:'بنوك'}, difficulty:'easy'
  },
  {
    from:{en:'Incoming Call: +965 2XXX XXXX (displays as "Ministry of Interior")',ar:'مكالمة واردة: +965 2XXX XXXX (تظهر كـ "وزارة الداخلية")'},
    subject:{en:'',ar:''},
    body:{en:'<em>Phone call...</em>\n\n"Good afternoon. I am Major Khalid from the Cybercrime Investigation Department, Ministry of Interior.\n\nWe have a file open against you for <strong>financial fraud and money laundering</strong>. A warrant will be issued for your arrest within 2 hours unless you cooperate.\n\nTo avoid arrest, transfer <strong>KWD 800</strong> to the following account as a guarantee deposit. Once cleared, you will be fully refunded.\n\nDo not share this call with anyone — this is a classified investigation."',ar:'<em>مكالمة هاتفية...</em>\n\n"مساء الخير. أنا الرائد خالد من إدارة تحقيقات الجرائم الإلكترونية، وزارة الداخلية.\n\nعندنا ملف مفتوح ضدك بتهمة <strong>الاحتيال المالي وغسيل الأموال</strong>. سيتم إصدار مذكرة توقيفك خلال ساعتين إذا لم تتعاون.\n\nلتجنب الاعتقال، حوّل <strong>800 دينار</strong> إلى الحساب التالي كوديعة ضمان. بعد التحقق سيُعاد المبلغ كاملاً.\n\nلا تشارك هذه المكالمة مع أحد — هذه تحقيقات سرية."'},
    q:{en:'A "police officer" threatens arrest unless you transfer money. What is this?',ar:'"ضابط شرطة" يهدد بالاعتقال ما لم تحوّل فلوس. ما هذا؟'},
    opts:[{en:'Take it seriously — better safe than sorry',ar:'خذها بجدية — الأمان أولاً'},{en:'Impersonation + arrest threat scam — hang up and call 112',ar:'احتيال انتحال شخصية + تهديد اعتقال — أقفل وتصل على 112'},{en:'Ask for the officer\'s badge number before anything',ar:'اطلب رقم شارة الضابط قبل أي شيء'},{en:'Transfer the money — you can dispute it later',ar:'حوّل الفلوس — ممكن تعترض عليها لاحقاً'}],
    correct:1,
    feedback:{en:'🚨 <strong>Hang up immediately!</strong> This is the "police impersonation" scam — one of the most psychologically powerful scam types. Key facts: (1) Real Kuwait police NEVER ask for money transfers over the phone. (2) Real warrants are served in person, not announced by phone call. (3) The "keep it secret" instruction is to stop you from consulting family or lawyers. (4) Caller ID can be faked to show any name/number. If you ever get this call, hang up and call 112 or go to your local police station.',ar:'🚨 <strong>أغلق الخط فوراً!</strong> هذا احتيال "انتحال شخصية الشرطة" — من أقوى أنواع الاحتيال نفسياً. حقائق مهمة: (1) شرطة الكويت الحقيقية لا تطلب أبداً تحويل أموال عبر الهاتف. (2) مذكرات الاعتقال الحقيقية تُنفَّذ شخصياً وليس بمكالمة هاتفية. (3) تعليمة "لا تخبر أحد" لمنعك من استشارة الأهل أو المحامين. (4) معرّف المتصل يمكن تزويره لأي اسم أو رقم. إذا وصلتك هذه المكالمة، أغلق واتصل على 112 أو اذهب لأقرب مركز شرطة.'},
    category:{en:'Impersonation', ar:'انتحال شخصية'}, difficulty:'hard'
  },
  {
    from:{en:'SMS: Talabat',ar:'SMS: Talabat'},
    subject:{en:'',ar:''},
    body:{en:'Talabat: Your order #TLB-9283847 from <strong>McDonald\'s Salmiya</strong> has been cancelled due to a payment issue.\n\nTo reschedule, update your payment details:\n<span class="scenario-link">https://talabat-kw.net/payment/update</span>\n\nOr contact Talabat support.',ar:'Talabat: تم إلغاء طلبك #TLB-9283847 من <strong>ماكدونالدز السالمية</strong> بسبب مشكلة في الدفع.\n\nلإعادة الجدولة، حدّث بيانات دفعك:\n<span class="scenario-link">https://talabat-kw.net/payment/update</span>\n\nأو تواصل مع دعم Talabat.'},
    q:{en:'You didn\'t order from McDonald\'s today. What do you do?',ar:'أنت لم تطلب من ماكدونالدز اليوم. ماذا تفعل؟'},
    opts:[{en:'Click the link to check — maybe someone used your account',ar:'اضغط الرابط للتحقق — ربما أحد استخدم حسابك'},{en:'Ignore it — wrong number probably',ar:'تجاهله — على الأغلب رقم خطأ'},{en:'Open the official Talabat app to check your order history directly',ar:'افتح تطبيق Talabat الرسمي وتحقق من سجل طلباتك مباشرة'},{en:'Call McDonald\'s to confirm',ar:'اتصل بماكدونالدز للتأكيد'}],
    correct:2,
    feedback:{en:'✅ <strong>Perfect!</strong> When you get a notification about something you didn\'t do, ALWAYS check through the official app — never through a link in the message. The domain talabat-kw.net is fake; the real Talabat website is talabat.com. This scam works because victims who see "cancelled order" get confused and click before thinking. Your order history in the app will show nothing if it\'s a scam.',ar:'✅ <strong>ممتاز!</strong> عندما تصلك إشعار عن شيء لم تفعله، دائماً تحقق عبر التطبيق الرسمي — وليس عبر رابط في الرسالة. النطاق talabat-kw.net مزيف؛ موقع Talabat الحقيقي هو talabat.com. هذا الاحتيال ينجح لأن الضحايا الذين يرون "طلب ملغى" يتشتتون ويضغطون قبل التفكير. سجل طلباتك في التطبيق سيظهر لا شيء إذا كانت نصبة.'},
    category:{en:'Delivery', ar:'توصيل'}, difficulty:'easy'
  },
  {
    from:{en:'Telegram: Kuwait_Crypto_Signals_VIP',ar:'تيليغرام: Kuwait_Crypto_Signals_VIP'},
    subject:{en:'',ar:''},
    body:{en:'🚨 <strong>URGENT: BTC Signal — Buy NOW</strong>\n\nOur AI system just confirmed: Bitcoin will rise 40% in the next 48 hours. Our last 10 signals were all 100% accurate! 📈\n\n✅ Top signal providers in Kuwait since 2019\n✅ 3,200+ verified Kuwaiti members\n✅ Lifetime VIP: Only <strong>KWD 250</strong> (was KWD 800)\n\nJoin before the price moves! Limited spots left.\n\n<span class="scenario-link">https://t.me/KW_Crypto_VIP_Premium</span>',ar:'🚨 <strong>عاجل: إشارة BTC — اشترِ الآن</strong>\n\nنظامنا بالذكاء الاصطناعي أكّد للتو: البيتكوين سيرتفع 40% في الـ48 ساعة القادمة. إشاراتنا الـ10 الأخيرة كلها كانت دقيقة 100%! 📈\n\n✅ أفضل مزودي إشارات بالكويت منذ 2019\n✅ 3,200+ عضو كويتي موثق\n✅ VIP مدى الحياة: فقط <strong>250 دينار</strong> (كان 800)\n\nانضم قبل تحرك السعر! أماكن محدودة.'},
    q:{en:'Why is "100% accurate signals" an instant red flag?',ar:'لماذا "إشارات دقيقة 100%" هي علامة تحذير فورية؟'},
    opts:[{en:'It\'s not — AI systems can genuinely predict markets',ar:'ليست كذلك — أنظمة الذكاء الاصطناعي تستطيع التنبؤ بالأسواق فعلاً'},{en:'No financial instrument can guarantee 100% accuracy — this is mathematically impossible',ar:'لا أداة مالية تضمن دقة 100% — هذا مستحيل رياضياً'},{en:'Only suspicious because they charge for it',ar:'مشبوهة فقط لأنهم يتقاضون رسوماً'},{en:'100% accuracy is possible for short-term crypto trades',ar:'الدقة 100% ممكنة في صفقات الكريبتو قصيرة الأمد'}],
    correct:1,
    feedback:{en:'✅ <strong>Correct!</strong> "100% accuracy" is mathematically impossible in financial markets — even the world\'s best investment firms don\'t achieve it. When someone claims it, they\'re either lying about past results (showing only winning trades) or running a Ponzi scheme where they pay early subscribers from new subscriber fees. Never pay for "signal channels" — this is not investing, it\'s gambling with extra fraud on top.',ar:'✅ <strong>صح!</strong> "الدقة 100%" مستحيلة رياضياً في الأسواق المالية — حتى أفضل شركات الاستثمار في العالم لا تحققها. عندما يدّعي شخص ذلك، إما يكذب بشأن النتائج السابقة (يعرض فقط الصفقات الرابحة) أو يدير مخطط بونزي يدفع فيه لمشتركين مبكرين من رسوم المشتركين الجدد. لا تدفع أبداً لـ"قنوات إشارات" — هذا ليس استثماراً، هو مقامرة مع احتيال إضافي.'},
    category:{en:'Crypto Scam', ar:'احتيال كريبتو'}, difficulty:'medium'
  },
  {
    from:{en:'Email: info@national-lottery-kw.com',ar:'إيميل: info@national-lottery-kw.com'},
    subject:{en:'🏆 You Won KWD 15,000 — Claim Within 72 Hours',ar:'🏆 فزت بـ 15,000 دينار — استلم خلال 72 ساعة'},
    body:{en:'Dear Kuwait Resident,\n\nCongratulations! Your phone number <strong>+965-9XXX-XXXX</strong> was randomly selected in the <strong>Kuwait National Digital Lottery 2026</strong>.\n\n🏆 Prize Amount: <strong>KWD 15,000.000</strong>\n\nTo claim your prize:\n1. Reply with your full name, Civil ID, and bank account details\n2. Pay the <strong>processing fee of KWD 50</strong> within 72 hours\n3. Your prize will be transferred within 3 business days\n\nContact our prize coordinator: lottery-coordinator@national-lottery-kw.com',ar:'عزيزي المقيم بالكويت،\n\nمبروك! رقم هاتفك <strong>+965-9XXX-XXXX</strong> تم اختياره عشوائياً في <strong>اليانصيب الرقمي الوطني الكويتي 2026</strong>.\n\n🏆 مبلغ الجائزة: <strong>15,000.000 دينار</strong>\n\nلاستلام جائزتك:\n1. ردّ بالاسم الكامل والبطاقة المدنية وبيانات حسابك البنكي\n2. ادفع <strong>رسوم المعالجة 50 دينار</strong> خلال 72 ساعة\n3. سيتم تحويل جائزتك خلال 3 أيام عمل'},
    q:{en:'Which element immediately exposes this as a scam?',ar:'أي عنصر يكشف هذا فوراً كاحتيال؟'},
    opts:[{en:'Kuwait doesn\'t have a national lottery',ar:'الكويت ليس فيها يانصيب وطني'},{en:'You have to pay a fee to receive your "prize"',ar:'يجب أن تدفع رسوماً لتستلم "جائزتك"'},{en:'They ask for your Civil ID and bank details by email',ar:'يطلبون بطاقتك المدنية وبياناتك البنكية بالإيميل'},{en:'All of the above — classic advance fee fraud',ar:'كل ما فوق — احتيال رسوم مسبقة كلاسيكي'}],
    correct:3,
    feedback:{en:'✅ <strong>All correct!</strong> This is the oldest scam in the book — advance fee fraud: (1) Kuwait has no national lottery. (2) Real prizes NEVER require paying to claim them — if you won, they pay you, not the other way around. (3) Sharing Civil ID + bank details = identity theft + potential account draining. The "72-hour deadline" creates urgency and the prize amount creates greed — a deadly combination.',ar:'✅ <strong>كلها صحيحة!</strong> هذا من أقدم أنواع الاحتيال — احتيال الرسوم المسبقة: (1) الكويت ليس فيها يانصيب وطني. (2) الجوائز الحقيقية لا تتطلب أبداً دفع رسوم لاستلامها — إذا فزت، هم يدفعون لك وليس العكس. (3) مشاركة البطاقة المدنية + البيانات البنكية = سرقة هوية + احتمال تفريغ حسابك. "مهلة 72 ساعة" تخلق استعجالاً ومبلغ الجائزة يخلق طمعاً — مزيج قاتل.'},
    category:{en:'Prize Scam', ar:'احتيال جوائز'}, difficulty:'easy'
  },
  {
    from:{en:'WhatsApp: +971 4X XXX XXXX',ar:'واتساب: +971 4X XXX XXXX'},
    subject:{en:'',ar:''},
    body:{en:'Hello,\n\nI\'m Dr. Fatima Al-Rashidi, real estate investment advisor.\n\nI\'m currently in Dubai managing a portfolio of Kuwaiti investors. One of our investors had to exit urgently — there\'s an <strong>available share worth KWD 4,000</strong> with projected returns of <strong>22% annually</strong>.\n\nThis is exclusive to my network only. I thought of you specifically.\n\nInterested? I can send you the full investment documents. Time is limited.',ar:'مرحباً،\n\nأنا د. فاطمة الراشدي، مستشارة استثمارات عقارية.\n\nأنا حالياً في دبي أدير محفظة لمستثمرين كويتيين. أحد مستثمرينا اضطر للخروج بشكل مستعجل — يوجد <strong>حصة متاحة بقيمة 4,000 دينار</strong> مع عائد متوقع <strong>22% سنوياً</strong>.\n\nهذا حصري لشبكتي فقط. فكرت فيك تحديداً.\n\nمهتم؟ أقدر أرسل لك مستندات الاستثمار الكاملة. الوقت محدود.'},
    q:{en:'What manipulation tactics are used in this message?',ar:'ما أساليب التلاعب المستخدمة في هذه الرسالة؟'},
    opts:[{en:'Exclusivity ("exclusive to my network only")',ar:'الحصرية ("حصري لشبكتي فقط")'},{en:'Guaranteed high returns (22% annually)',ar:'عائد مرتفع مضمون (22% سنوياً)'},{en:'Personal targeting ("I thought of you specifically") + artificial urgency',ar:'استهداف شخصي ("فكرت فيك تحديداً") + استعجال مصطنع'},{en:'All of the above — a professional manipulation funnel',ar:'كل ما فوق — قمع تلاعب احترافي'}],
    correct:3,
    feedback:{en:'✅ <strong>Excellent analysis!</strong> This is a sophisticated investment scam using 4 manipulation layers: (1) Exclusivity — "only my network" makes you feel privileged. (2) Guaranteed returns — 22% annually is impossible to guarantee legitimately. (3) Personalization — "I thought of you specifically" builds false trust. (4) Urgency — "time is limited" stops you from doing proper research. Real investment opportunities don\'t come through WhatsApp cold messages from unknown UAE numbers.',ar:'✅ <strong>تحليل ممتاز!</strong> هذا احتيال استثمار متطور يستخدم 4 طبقات تلاعب: (1) الحصرية — "شبكتي فقط" يجعلك تشعر بامتياز. (2) عائد مضمون — 22% سنوياً مستحيل ضمانه بشكل شرعي. (3) التشخيص — "فكرت فيك تحديداً" يبني ثقة زائفة. (4) الاستعجال — "الوقت محدود" يمنعك من البحث الصحيح. الفرص الاستثمارية الحقيقية لا تأتي عبر رسائل واتساب باردة من أرقام إماراتية مجهولة.'},
    category:{en:'Investment Scam', ar:'احتيال استثمار'}, difficulty:'hard'
  },
  {
    from:{en:'SMS: 97500000',ar:'SMS: 97500000'},
    subject:{en:'',ar:''},
    body:{en:'Hi, I saw your car listed for sale on OpenSooq.\n\nI\'m interested in buying it. I\'m currently abroad but I can send payment via <strong>KNET or bank transfer</strong> right now.\n\nTo confirm my order and reserve the car, please send me a verification code — I\'ll send a code to your phone via KNET portal to confirm the transaction.\n\nPlease share the code when you receive it. 🙏',ar:'هلا، شفت سيارتك معروضة للبيع في OpenSooq.\n\nأنا مهتم بشرائها. أنا حالياً في الخارج لكن أقدر أرسل الدفع عبر <strong>KNET أو تحويل بنكي</strong> الحين.\n\nلتأكيد طلبي وحجز السيارة، أرسل لي رمز تحقق — سأرسل رمزاً لهاتفك عبر بوابة KNET لتأكيد العملية.\n\nيرجى مشاركة الرمز عند استلامه. 🙏'},
    q:{en:'A buyer asks you to share a code "sent by KNET" to confirm payment. What is happening?',ar:'مشترٍ يطلب منك مشاركة رمز "أرسله KNET" لتأكيد الدفع. ماذا يحدث؟'},
    opts:[{en:'KNET sometimes uses this for remote transactions',ar:'KNET أحياناً تستخدم هذا للمعاملات عن بُعد'},{en:'The code sent to your phone is YOUR bank OTP — sharing it lets them drain your account',ar:'الرمز المرسل لهاتفك هو OTP حسابك البنكي — مشاركته يسمح لهم بتفريغ حسابك'},{en:'It\'s a legitimate buyer concern about fraud',ar:'هذا قلق مشترٍ شرعي من الاحتيال'},{en:'Only a scam if they refuse to meet in person',ar:'احتيال فقط إذا رفضوا الاجتماع شخصياً'}],
    correct:1,
    feedback:{en:'🚨 <strong>Reverse scam — targeting sellers!</strong> Here\'s what\'s really happening: "Sending a code from KNET" is a lie. What they actually do is: (1) They try to log into your bank or make a transfer FROM your account. (2) Your bank sends you an OTP to authorize the transaction. (3) They tell you that OTP is from "KNET to confirm payment" — but if you share it, they authorize a withdrawal FROM your account. You become the victim, not the beneficiary. Never share OTP codes, ever.',ar:'🚨 <strong>احتيال معكوس — يستهدف البائعين!</strong> ما يحدث فعلاً: "إرسال رمز من KNET" هو كذب. ما يفعله فعلاً: (1) يحاول الدخول لحسابك البنكي أو إجراء تحويل من حسابك. (2) بنكك يرسلك OTP لتفويض العملية. (3) يخبرك أن هذا الـ OTP من "KNET لتأكيد الدفع" — لكن إذا شاركته، يُفوّضون سحباً من حسابك. أنت تصبح الضحية وليس المستفيد. لا تشارك رموز OTP أبداً، مطلقاً.'},
    category:{en:'Social Engineering', ar:'هندسة اجتماعية'}, difficulty:'hard'
  },
  {
    from:{en:'SMS: BoubyanBank',ar:'SMS: BoubyanBank'},
    subject:{en:'',ar:''},
    body:{en:'Boubyan Bank:\nDear customer, we are upgrading our security system.\n\nAs part of the upgrade, please confirm your account details remain active by logging in:\n<span class="scenario-link">https://boubyan-secure-update.com/verify</span>\n\nIf you do not log in within 24 hours, your account may be temporarily restricted during migration.\n\nThank you for your patience. — Boubyan Bank Security Team',ar:'بنك بوبيان:\nعزيزي العميل، نحن نقوم بترقية نظام الأمان لدينا.\n\nكجزء من الترقية، يرجى تأكيد أن بيانات حسابك لا تزال نشطة بتسجيل الدخول:\n<span class="scenario-link">https://boubyan-secure-update.com/verify</span>\n\nإذا لم تسجّل دخولك خلال 24 ساعة، قد يتم تقييد حسابك مؤقتاً أثناء الترحيل.\n\nشكراً على صبرك. — فريق أمن بنك بوبيان'},
    q:{en:'This SMS appears to come from BoubyanBank. Why is the link suspicious?',ar:'هذه الرسالة تبدو قادمة من بنك بوبيان. لماذا الرابط مشبوه؟'},
    opts:[{en:'Banks never upgrade security',ar:'البنوك لا ترقّي الأمان أبداً'},{en:'boubyan-secure-update.com is not the official domain — which is boubyanbank.com.kw',ar:'boubyan-secure-update.com ليس النطاق الرسمي — الذي هو boubyanbank.com.kw'},{en:'The 24-hour deadline',ar:'مهلة 24 ساعة'},{en:'Both B and C — wrong domain + pressure deadline',ar:'ب و ج — نطاق خاطئ + ضغط المهلة'}],
    correct:3,
    feedback:{en:'✅ <strong>Correct!</strong> Two red flags: (1) Domain: boubyan-secure-update.com ≠ boubyanbank.com.kw. Scammers buy hyphenated or extra-word domains to mimic real banks. (2) Banks do NOT require you to log in via SMS link when they upgrade their systems — upgrades happen server-side without any action needed from you. A real bank system upgrade affects no customer-facing login at all.',ar:'✅ <strong>صح!</strong> علامتا تحذير: (1) النطاق: boubyan-secure-update.com ≠ boubyanbank.com.kw. المحتالون يشترون نطاقات بشرطات أو كلمات إضافية لمحاكاة البنوك الحقيقية. (2) البنوك لا تطلب منك تسجيل الدخول عبر رابط SMS عند ترقية أنظمتها — الترقيات تحدث على جانب الخادم بدون أي إجراء منك. ترقية نظام بنك حقيقية لا تؤثر على تسجيل الدخول من طرف العميل إطلاقاً.'},
    category:{en:'Banking', ar:'بنوك'}, difficulty:'medium'
  }
];
...
function loadScenario(){
  ...
  if(platTag){
    ...
    var platTxt='';
    if(/واتساب|whatsapp/.test(fl2)) platTxt='WhatsApp';
    else if(/تيليغرام|telegram/.test(fl2)) platTxt='Telegram';
    else if(/إيميل|email/.test(fl2)) platTxt='Email';
    else if(/مكالمة|call/.test(fl2)) platTxt=LANG==='ar'?'مكالمة':'Call';
    else if(/instagram/.test(fl2)) platTxt='Instagram';
    else platTxt='SMS';
  ...
  if(iconEl){
    ...
    else if(/instagram/.test(fl)) iconEl.textContent='📸';
  ...
  s.opts.forEach(function(o,i){
    opts+='<button class="sim-opt" onclick="answerSim('+i+')">' +
      '<span class="sim-opt-letter">'+OPTION_LETTERS[i]+'</span>' +
      '<span>'+rt(o)+'</span>' +
    '</button>';
  });
...
function answerSim(idx){
  ...
  if(strkEl) strkEl.textContent=simStreak>=2?'🔥 x'+simStreak:'';

  var fb=document.getElementById('simFeedback');
  var prefix=isCorrect
    ?'<b style="color:#00ff88">✅ '+(LANG==='ar'?'إجابة صحيحة!':'Correct!')+'</b> '
    :'<b style="color:#ff3c5a">❌ '+(LANG==='ar'?'إجابة خاطئة!':'Wrong!')+'</b> ';
...
function showScore(){
  ...
  if(pct>=0.95){grade='S';gradeColor='#00ff88';gradeGlow='rgba(0,255,136,0.4)';}
  else if(pct>=0.85){grade='A';gradeColor='#00d4ff';gradeGlow='rgba(0,212,255,0.4)';}
  else if(pct>=0.70){grade='B';gradeColor='#a855f7';gradeGlow='rgba(168,85,247,0.4)';}
  else if(pct>=0.55){grade='C';gradeColor='#f5a623';gradeGlow='rgba(245,166,35,0.4)';}
  else{grade='D';gradeColor='#ff3c5a';gradeGlow='rgba(255,60,90,0.4)';}

  var ring=document.getElementById('scoreGradeRing');
  if(ring){ring.style.setProperty('--sg-color',gradeColor);ring.style.borderColor=gradeColor;ring.style.boxShadow='0 0 30px '+gradeGlow;}
  ...
  if(bdEl){
    bdEl.innerHTML=
      '<div class="score-bd-item"><div class="score-bd-num" style="color:#00ff88">'+simScore+'</div><div class="score-bd-lbl">'+(LANG==='ar'?'صحيح':'Correct')+'</div></div>'+
      '<div class="score-bd-item"><div class="score-bd-num" style="color:#ff3c5a">'+wrong+'</div><div class="score-bd-lbl">'+(LANG==='ar'?'خطأ':'Wrong')+'</div></div>'+
      '<div class="score-bd-item"><div class="score-bd-num" style="color:#f5a623">'+Math.round(pct*100)+'%</div><div class="score-bd-lbl">'+(LANG==='ar'?'النتيجة':'Score')+'</div></div>';
  }
...
var COMMON_PASSWORDS = [
  'password','123456','qwerty','kuwait','admin','letmein','welcome','111111','123123','abc123',
  'password1','iloveyou','monkey','dragon','master','1234567890','000000','pass','test','login',
  'sunshine','princess','football','shadow','superman','michael','charlie','donald','password123',
  'q1w2e3','Password1','Password1!','Welcome1','Welcome@123','Admin123','Iloveyou','Letmein',
  'Monkey','Dragon','Master','princess','football','charlie','donald','batman','michael',
  'shadow','superman','harley','hunter','ranger','buster','soccer','hockey','baseball',
  'jordan','dallas','thomas','killer','andrew','daniel','george','pass123','test123',
  'abc123456','qwerty123','12345678','123456789','1234567890','password123','welcome123',
  ...
  'Pass@123','Kuwait@123','Iloveyou1','Letmein1!','Changeme1','Temp1234!','Root123!',
  'Summer2024','Winter2024','Spring2024','Password!1','1q2w3e4r','1q2w3e4r5t','zaq1@WSX',
  'QAZwsx123','asdf1234','zxcv1234','asdfjkl;','q1w2e3r4','a1b2c3d4','trustno1',
  'master123','dragon123','shadow123','michael1','jordan23','superman1','batman123'
];
...
async function checkPassword(){
  ...
  var hasSeqNum  = SEQUENTIAL_NUMS.some(function(s){ return pwd.indexOf(s) >= 0; });
  var hasSeqLet  = SEQUENTIAL_LETS.some(function(s){ return pwdLower.indexOf(s) >= 0; });
  var hasRevSeq  = REVERSE_SEQ.some(function(s){ return pwdLower.indexOf(s) >= 0; });
  var isDictWord = DICT_WORDS.some(function(w){ return pwdStripped === w || pwdLower === w; });
  var isCommon   = COMMON_PASSWORDS.some(function(c){ return pwdLower.indexOf(c.toLowerCase()) >= 0; });
  ...
  var checks = [
    ...
    { key:'pwd-c7',  pass: !isCommon },
    { key:'pwd-c8',  pass: !KEYBOARD_WALKS.some(function(w){ return pwdLower.indexOf(w) >= 0; }) },
    ...
    { key:'pwd-c13', pass: null }  // HIBP – will be updated async
  ];

  var passed = checks.filter(function(c){ return c.pass === true; }).length;
  var total  = checks.filter(function(c){ return c.pass !== null; }).length;
  var score  = total > 0 ? Math.round(passed / total * 100) : 0;

  // ── Stricter penalties for score
  if(hasSeqNum || hasSeqLet || hasRevSeq) score = Math.min(score, 35);
  if(isDictWord) score = Math.min(score, 20);
  if(isCommon)   score = 0;
  // Short passwords can never score high
  if(pwd.length <= 6) score = Math.min(score, 15);
  else if(pwd.length <= 8) score = Math.min(score, 40);
  else if(pwd.length <= 10) score = Math.min(score, 60);
  // All same case + only letters
  if(/^[a-z]+$/.test(pwd) || /^[A-Z]+$/.test(pwd)) score = Math.min(score, 20);
  // Only digits
  if(/^\d+$/.test(pwd)) score = Math.min(score, 10);
  // Repeated char
  ...
  if (isCommon) effectiveEntropy = 0;

  // Penalty: all same char
  if (/^(.)\1+$/.test(pwd)) effectiveEntropy = 0;

  // Penalty: only digits (e.g. "12345678") — severely penalize
  if (/^\d+$/.test(pwd)) effectiveEntropy = Math.min(effectiveEntropy * 0.15, 15);

  // Penalty: only lowercase letters (e.g. "password", "hello")
  if (/^[a-z]+$/.test(pwd)) effectiveEntropy = Math.min(effectiveEntropy * 0.2, 20);
  ...
  var hasDictWord = DICT_WORDS.some(function(w) { return stripped.length >= 4 && stripped.indexOf(w) !== -1; });
  if (hasDictWord) effectiveEntropy *= 0.2;

  // Penalty: sequential patterns
  var hasSeq = SEQUENTIAL_NUMS.concat(SEQUENTIAL_LETS, REVERSE_SEQ).some(function(s) { return pwd.toLowerCase().indexOf(s) !== -1; });
  if (hasSeq) effectiveEntropy *= 0.15;

  // Penalty: keyboard walks
  var hasWalk = KEYBOARD_WALKS.some(function(w) { return pwd.toLowerCase().indexOf(w) !== -1; });
  if (hasWalk) effectiveEntropy *= 0.15;
  ...
  var hasSubstDict = DICT_WORDS.some(function(w) { return desubst.indexOf(w) !== -1; });
  if (hasSubstDict) effectiveEntropy *= 0.2;
  ...
  if (uniqueRatio < 0.4) effectiveEntropy *= 0.3;

  // Short passwords — HARD caps
  if (pwd.length <= 4) effectiveEntropy = Math.min(effectiveEntropy, 5);
  else if (pwd.length <= 6) effectiveEntropy = Math.min(effectiveEntropy, 12);
  else if (pwd.length < 8) effectiveEntropy = Math.min(effectiveEntropy, 20);
  else if (pwd.length < 10) effectiveEntropy = Math.min(effectiveEntropy, 35);

  effectiveEntropy = Math.round(effectiveEntropy);

  // ── Crack time (10B guesses/sec with realistic thresholds)
  var crackTime;
  if (effectiveEntropy <= 0)       crackTime = '\u26A1 ' + (LANG==='ar' ? 'يُكسر فوراً' : 'Cracked instantly');
  else if (effectiveEntropy < 15)  crackTime = '\u26A1 ' + (LANG==='ar' ? 'أقل من ثانية' : 'Less than a second');
  else if (effectiveEntropy < 25)  crackTime = '\u26A1 ' + (LANG==='ar' ? 'ثوانٍ معدودة' : 'A few seconds');
  else if (effectiveEntropy < 30)  crackTime = '\u23F1\uFE0F ' + (LANG==='ar' ? 'أقل من دقيقة' : 'Under a minute');
  else if (effectiveEntropy < 35)  crackTime = '\u23F1\uFE0F ' + (LANG==='ar' ? 'بضع دقائق' : 'A few minutes');
  else if (effectiveEntropy < 40)  crackTime = '\uD83D\uDD50 ' + (LANG==='ar' ? 'أقل من ساعة' : 'Under an hour');
  else if (effectiveEntropy < 45)  crackTime = '\uD83D\uDD50 ' + (LANG==='ar' ? 'بضع ساعات' : 'A few hours');
  else if (effectiveEntropy < 50)  crackTime = '\uD83D\uDCC5 ' + (LANG==='ar' ? 'بضعة أيام' : 'A few days');
  else if (effectiveEntropy < 55)  crackTime = '\uD83D\uDCC5 ' + (LANG==='ar' ? 'بضعة أسابيع' : 'A few weeks');
  else if (effectiveEntropy < 60)  crackTime = '\uD83D\uDCC5 ' + (LANG==='ar' ? 'بضعة أشهر' : 'A few months');
  else if (effectiveEntropy < 65)  crackTime = '\uD83D\uDCC5 ' + (LANG==='ar' ? 'بضع سنوات' : 'A few years');
  else if (effectiveEntropy < 75)  crackTime = '\uD83D\uDD12 ' + (LANG==='ar' ? 'مئات السنين' : 'Hundreds of years');
  else if (effectiveEntropy < 85)  crackTime = '\uD83D\uDD12 ' + (LANG==='ar' ? 'آلاف السنين' : 'Thousands of years');
  else                             crackTime = '\uD83D\uDD12 ' + (LANG==='ar' ? 'ملايين السنين' : 'Millions of years');

  // ── Score label helper
  function getScoreLabel(s) {
    var lbl, col;
    if(s < 40)      { lbl = LANG==='ar'?'ضعيف جداً':'Very Weak';  col='#ff3c5a'; }
    else if(s < 55) { lbl = LANG==='ar'?'ضعيف':'Weak';            col='#ff7e3b'; }
    else if(s < 70) { lbl = LANG==='ar'?'متوسط':'Fair';           col='#ffd93d'; }
    else if(s < 85) { lbl = LANG==='ar'?'جيد':'Good';             col='#4cce8f'; }
    else            { lbl = LANG==='ar'?'قوي جداً':'Very Strong'; col='#00ff88'; }
  ...
  function renderUI(hibpCount) {
    ...
    if(bar){ bar.style.width = finalScore+'%'; bar.style.background = sl.color; }

    var scoreLbl = document.getElementById('pwdScoreLbl');
    var entropyEl = document.getElementById('pwdEntropy');
    if(scoreLbl){ scoreLbl.textContent = sl.label; scoreLbl.style.color = sl.color; }
    if(entropyEl){
      entropyEl.textContent =
        (LANG==='ar'?'أنتروبي':'Entropy')+': '+entropy+' bits (' + (LANG==='ar'?'فعّال':'effective') + ': ' + effectiveEntropy + ' bits)' +
        '  \u00B7  ' + (LANG==='ar'?'وقت الكسر':'Crack time')+': '+displayCrackTime;
    }
    ...
    var CHECK_LABELS = {
      ...
      'pwd-c13': {en:'Not found in known data breaches',      ar:'غير مسرّب في اختراقات بيانات معروفة'}
    };
    ...
    var hibpCheck;
    if(hibpCount === null) {
      hibpCheck = { key:'pwd-c13', pass: null, hibpPending: false, hibpNA: true };
    } else if(hibpCount === 0) {
      hibpCheck = { key:'pwd-c13', pass: true,  hibpCount: 0 };
    } else {
      hibpCheck = { key:'pwd-c13', pass: false, hibpCount: hibpCount };
    }
  ...
  if(entropyEl2){
    entropyEl2.textContent =
      (LANG==='ar'?'أنتروبي':'Entropy')+': '+entropy+' bits (' + (LANG==='ar'?'فعّال':'effective') + ': ' + effectiveEntropy + ' bits)' +
      '  \u00B7  ' + (LANG==='ar'?'جاري التحقق من قاعدة البيانات...':'Checking breach database...');
  }
  renderUI(null);  // null = pending
...
async function checkURLThreatIntel(url) {
  try {
    ...
    if (data.results && data.results.length > 0) {
      var malicious = data.results.filter(function(r){ return r.verdicts && r.verdicts.overall && r.verdicts.overall.malicious; });
      return { found: true, total: data.results.length, malicious: malicious.length, domain: domain };
    }
...
async function checkPhishTank(url) {
  try {
    ...
    var data = await resp.json();
    if (data.results) {
      return { isPhish: data.results.in_database && data.results.valid, verified: data.results.verified === 'yes' };
    }
    return null;
  } catch(e) { return null; }
}
...
async function checkIPQS(url) {
  ...
  try {
    ...
    var data = await resp.json();
    if (data.success) {
      return { riskScore: data.risk_score || 0, phishing: data.phishing, malware: data.malware, suspicious: data.suspicious, domainAge: data.domain_age ? data.domain_age.human : null };
    }
    return null;
  } catch(e) { return null; }
}
...
async function runLinkAPIChecks(url, hostname, baseRiskScore, baseVerdictClass) {
  ...
  if (apiResults[0]) {
    apiChecked++;
    if (apiResults[0].malicious > 0) { threatsFound++; items[0].className='lr-api-item apid-mal'; items[0].innerHTML='<span class="apid-ico">✗</span><span class="apid-api">URLScan.io</span><span class="apid-detail">'+apiResults[0].malicious+' malicious verdicts</span>'; }
    else if (apiResults[0].found) { items[0].className='lr-api-item apid-seen'; items[0].innerHTML='<span class="apid-ico">•</span><span class="apid-api">URLScan.io</span><span class="apid-detail">'+apiResults[0].total+' records found</span>'; }
    else { items[0].className='lr-api-item apid-clean'; items[0].innerHTML='<span class="apid-ico">✓</span><span class="apid-api">URLScan.io</span><span class="apid-detail">'+(LANG==='ar'?'لم يُرصد':'Not found in database')+'</span>'; }
  } else { items[0].className='lr-api-item apid-na'; items[0].innerHTML='<span class="apid-ico">—</span><span class="apid-api">URLScan.io</span><span class="apid-detail">'+(LANG==='ar'?'غير متاح':'Unavailable')+'</span>'; }
  ...
  if (apiResults[1]) {
    ...
    if (vtMal > 0) { threatsFound++; items[1].className='lr-api-item apid-mal'; items[1].innerHTML='<span class="apid-ico">✗</span><span class="apid-api">VirusTotal</span><span class="apid-detail">'+vtMal+'/'+vtTotal+' engines flagged</span>'; }
    else { items[1].className='lr-api-item apid-clean'; items[1].innerHTML='<span class="apid-ico">✓</span><span class="apid-api">VirusTotal</span><span class="apid-detail">0/'+vtTotal+' — clean</span>'; }
  } else { items[1].className='lr-api-item apid-na'; items[1].innerHTML='<span class="apid-ico">—</span><span class="apid-api">VirusTotal</span><span class="apid-detail">'+(LANG==='ar'?'أضف مفتاح API':'Add API key')+'</span>'; }

  // Process GSB
  if (apiResults[2]) {
    apiChecked++;
    if (apiResults[2].length > 0) { threatsFound++; items[2].className='lr-api-item apid-mal'; items[2].innerHTML='<span class="apid-ico">✗</span><span class="apid-api">Google Safe Browsing</span><span class="apid-detail">'+apiResults[2].map(function(m){return m.threatType;}).join(', ')+'</span>'; }
    else { items[2].className='lr-api-item apid-clean'; items[2].innerHTML='<span class="apid-ico">✓</span><span class="apid-api">Google Safe Browsing</span><span class="apid-detail">'+(LANG==='ar'?'نظيف':'Clean')+'</span>'; }
  } else { items[2].className='lr-api-item apid-na'; items[2].innerHTML='<span class="apid-ico">—</span><span class="apid-api">Google Safe Browsing</span><span class="apid-detail">'+(LANG==='ar'?'أضف مفتاح API':'Add API key')+'</span>'; }

  // Process PhishTank
  if (apiResults[3]) {
    apiChecked++;
    if (apiResults[3].isPhish) { threatsFound++; items[3].className='lr-api-item apid-mal'; items[3].innerHTML='<span class="apid-ico">✗</span><span class="apid-api">PhishTank</span><span class="apid-detail">'+(LANG==='ar'?'تصيد مؤكد':'Confirmed phishing')+(apiResults[3].verified?' ✓':'')+'</span>'; }
    else { items[3].className='lr-api-item apid-clean'; items[3].innerHTML='<span class="apid-ico">✓</span><span class="apid-api">PhishTank</span><span class="apid-detail">'+(LANG==='ar'?'ليس تصيداً':'Not phishing')+'</span>'; }
  } else { items[3].className='lr-api-item apid-na'; items[3].innerHTML='<span class="apid-ico">—</span><span class="apid-api">PhishTank</span><span class="apid-detail">'+(LANG==='ar'?'غير متاح':'Unavailable')+'</span>'; }

  // Process IPQS
  if (apiResults[4]) {
    apiChecked++;
    if (apiResults[4].phishing || apiResults[4].malware) { threatsFound++; items[4].className='lr-api-item apid-mal'; items[4].innerHTML='<span class="apid-ico">✗</span><span class="apid-api">IPQualityScore</span><span class="apid-detail">Risk: '+apiResults[4].riskScore+'/100'+(apiResults[4].phishing?' | Phishing':'')+(apiResults[4].malware?' | Malware':'')+(apiResults[4].domain_age?' | Age: '+apiResults[4].domain_age:'')+'</span>'; }
    else if (apiResults[4].suspicious || apiResults[4].riskScore >= 75) { items[4].className='lr-api-item apid-sus'; items[4].innerHTML='<span class="apid-ico">!</span><span class="apid-api">IPQualityScore</span><span class="apid-detail">Risk: '+apiResults[4].riskScore+'/100 — '+(LANG==='ar'?'مشبوه':'Suspicious')+'</span>'; }
    else { items[4].className='lr-api-item apid-clean'; items[4].innerHTML='<span class="apid-ico">✓</span><span class="apid-api">IPQualityScore</span><span class="apid-detail">Risk: '+apiResults[4].riskScore+'/100'+(apiResults[4].domain_age?' | Age: '+apiResults[4].domain_age:'')+'</span>'; }
  } else { items[4].className='lr-api-item apid-na'; items[4].innerHTML='<span class="apid-ico">—</span><span class="apid-api">IPQualityScore</span><span class="apid-detail">'+(LANG==='ar'?'أضف مفتاح API':'Add API key')+'</span>'; }
...
function _breachChipClass(field) {
  ...
  if (high.test(field)) return 'bc-high';
  if (med.test(field))  return 'bc-med';
  return 'bc-low';
}

function _breachSeverity(fields) {
  // fields: array of strings
  var hasHigh = fields.some(function(f){ return /password|passwd|credit|ssn|bank|financial|payment/i.test(f); });
  var hasMed  = fields.some(function(f){ return /email|phone|address|dob|name|username/i.test(f); });
  if (hasHigh) return 'critical';
  if (hasMed)  return 'high';
  return 'medium';
}
...
async function scanBreach() {
  ...
  if (scanBtn) { scanBtn.disabled = true; scanBtn.textContent = LANG==='ar'?'جاري الفحص...':'Scanning...'; }

  // Show loading with steps
  res.style.display = 'block';
  res.innerHTML = '<div class="breach-loading">' +
    '<div class="breach-loading-spinner"><span>🔍</span></div>' +
    '<div class="breach-loading-steps">' +
      '<div class="breach-loading-step active" id="bls1"><span class="bls-ico">⏳</span> ' + (LANG==='ar'?'الاتصال بقاعدة البيانات...':'Connecting to database...') + '</div>' +
      '<div class="breach-loading-step" id="bls2"><span class="bls-ico">○</span> ' + (LANG==='ar'?'البحث عن التسريبات...':'Searching for breaches...') + '</div>' +
      '<div class="breach-loading-step" id="bls3"><span class="bls-ico">○</span> ' + (LANG==='ar'?'جلب التفاصيل...':'Fetching details...') + '</div>' +
    '</div>' +
    '</div>';
  ...
  function setStep(id, state) {
    ...
    if (ico) ico.textContent = state === 'done' ? '✓' : state === 'active' ? '⏳' : '○';
  }
  ...
  try {
    ...
    var quickData = null;
    try { quickData = await quickResp.json(); } catch(e) {}
    ...
    if (isBreached) {
      quickData.breaches.forEach(function(arr) {
        if (Array.isArray(arr)) { arr.forEach(function(n){ if(n) breachNames.push(n); }); }
        else if (typeof arr === 'string') { breachNames.push(arr); }
      });
    }
    ...
    if (scanTotalEl) scanTotalEl.textContent = scanTotal;

    if (!isBreached || breachNames.length === 0) {
      // ── SAFE
      html += '<div class="breach-summary breach-safe">' +
        '<div class="breach-summary-ico">✅</div>' +
        '<div class="breach-summary-body">' +
          '<div class="breach-summary-title">' + (LANG === 'ar' ? 'لم يُكتشف أي تسريب!' : 'No breaches found!') + '</div>' +
          '<div class="breach-summary-sub">' + (LANG === 'ar'
            ? 'الإيميل <b>' + email + '</b> لم يُكتشف في أي تسريب بيانات في قاعدة XposedOrNot.'
            : 'The email <b>' + email + '</b> was not found in any known data breaches in the XposedOrNot database.') +
          '</div>' +
        '</div></div>';
    } else {
      setStep('bls3', 'active');
      // ── Step 2: fetch rich breach details
      var details = {}; // keyed by breach name (lowercased)
      try {
        var richResp = await fetchWithProxy('https://api.xposedornot.com/v1/breach-analytics?email=' + encodeURIComponent(email), {
          headers: { 'Accept': 'application/json' }
        });
        var richData = null;
        try { richData = await richResp.json(); } catch(e) {}
      ...
      breachNames.forEach(function(name) {
        ...
        var xposed = det.xposed_data ? det.xposed_data.split(';').map(function(s){ return s.trim(); }).filter(Boolean) : [];
        xposed.forEach(function(f){ allDataTypes[f] = (allDataTypes[f] || 0) + 1; });
        if (_breachSeverity(xposed) === 'critical') highRiskCount++;
      });
      ...
      // ── Risk meter
      html += '<div class="breach-risk-meter">' +
        '<div class="breach-risk-label">' + (LANG==='ar'?'مستوى الخطر':'EXPOSURE RISK LEVEL') + '</div>' +
        '<div class="breach-risk-track"><div class="breach-risk-fill" style="width:' + riskPercent + '%;background:' + riskColor + '"></div></div>' +
        '<div class="breach-risk-details"><span>' + riskPercent + '%</span><span>' + total + ' ' + (LANG==='ar'?'تسريب':'breaches') + ' · ' + uniqueDataTypes + ' ' + (LANG==='ar'?'نوع بيانات':'data types') + '</span></div>' +
        '</div>';

      // ── Data type summary pills
      if (uniqueDataTypes > 0) {
        var topTypes = Object.keys(allDataTypes).sort(function(a,b){ return allDataTypes[b]-allDataTypes[a]; }).slice(0, 6);
      ...
      // ── Summary banner
      html += '<div class="breach-summary breach-danger">' +
        '<div class="breach-summary-ico">🚨</div>' +
        '<div class="breach-summary-body">' +
          '<div class="breach-summary-title">' + (LANG === 'ar'
            ? 'مكتشف في ' + total + ' تسريب!'
            : 'Found in ' + total + ' breach' + (total !== 1 ? 'es' : '') + '!') + '</div>' +
          '<div class="breach-summary-sub">' + (LANG === 'ar'
            ? 'الإيميل <b>' + email + '</b> ظهر في تسريبات بيانات. غيّر كلمات المرور الآن!'
            : 'The email <b>' + email + '</b> appeared in known data breaches. Change your passwords immediately!') +
          '</div>' +
        '</div></div>';
      ...
      breachNames.forEach(function(name, idx) {
        ...
        var sevLabel = sev === 'critical' ? (LANG === 'ar' ? 'حرج' : 'Critical')
                     : sev === 'high'     ? (LANG === 'ar' ? 'عالي' : 'High')
        ...
        html += '<div class="breach-card" id="bcard-' + idx + '" onclick="toggleBreachItem(' + idx + ')">' +
          '<div class="breach-card-header">' +
            '<div style="font-size:1.3rem;line-height:1">🔓</div>' +
            '<div style="flex:1;min-width:0">' +
              '<div style="font-weight:700;font-size:0.9rem;margin-bottom:3px">' + name + '</div>' +
              '<div style="display:flex;flex-wrap:wrap;gap:4px;align-items:center">' +
                (dateStr ? '<span style="font-size:0.6rem;color:var(--muted);margin-right:4px">📅 ' + dateStr + '</span>' : '') +
                previewChips +
              '</div>' +
            '</div>' +
            '<span class="breach-severity ' + sevClass + '">' + sevLabel + '</span>' +
            '<span class="breach-card-arrow">▼</span>' +
          '</div>' +
          '<div class="breach-card-body">' +
            '<div class="breach-card-detail">' +
              (domain    ? '<div class="bcd-row"><span class="bcd-key">' + (LANG==='ar'?'الموقع':'Domain') + '</span><span class="bcd-val">' + domain + '</span></div>' : '') +
              (industry  ? '<div class="bcd-row"><span class="bcd-key">' + (LANG==='ar'?'القطاع':'Industry') + '</span><span class="bcd-val">' + industry + '</span></div>' : '') +
              (dateStr   ? '<div class="bcd-row"><span class="bcd-key">' + (LANG==='ar'?'التاريخ':'Date') + '</span><span class="bcd-val">' + dateStr + '</span></div>' : '') +
              (xposed.length ? '<div class="bcd-row" style="align-items:flex-start"><span class="bcd-key">' + (LANG==='ar'?'البيانات':'Data') + '</span>' +
                '<span class="bcd-val" style="display:flex;flex-wrap:wrap;gap:4px">' +
                  xposed.map(function(f){ return '<span class="breach-chip ' + _breachChipClass(f) + '">' + f + '</span>'; }).join('') +
                '</span></div>' : '') +
              (desc ? '<div class="bcd-row" style="align-items:flex-start"><span class="bcd-key">' + (LANG==='ar'?'الوصف':'Info') + '</span><span class="bcd-val" style="font-size:0.7rem;color:var(--muted);line-height:1.5">' + desc.replace(/<[^>]+>/g,'') + '</span></div>' : '') +
              (!domain && !industry && !dateStr && !xposed.length && !desc
                ? '<div style="font-size:0.72rem;color:var(--muted);padding:4px 0">' +
                  (LANG==='ar'
                    ? 'تفاصيل إضافية غير متوفرة لهذا التسريب.'
                    : 'No additional details available for this breach.') + '</div>'
                : '') +
            '</div>' +
          '</div>' +
        '</div>';
      });
      html += '</div>'; // .breach-list-wrap

      // ── Recommended actions
      html += '<div class="breach-privacy-note">' +
        '<b style="color:var(--orange)">⚠️ ' + (LANG === 'ar' ? 'الخطوات الموصى بها:' : 'Recommended Actions:') + '</b><br>' +
        (LANG === 'ar'
          ? '1. غيّر كلمة المرور على جميع الحسابات المرتبطة بهذا الإيميل<br>' +
            '2. فعّل التحقق بخطوتين (2FA) على جميع الحسابات<br>' +
            '3. استخدم كلمات مرور فريدة لكل حساب<br>' +
            '4. استخدم مدير كلمات مرور مثل Bitwarden أو 1Password'
          : '1. Change passwords on all accounts using this email<br>' +
            '2. Enable two-factor authentication (2FA) everywhere<br>' +
            '3. Use unique passwords for every account<br>' +
    ...
    if (!isBreached || breachNames.length === 0) {
      html += '<div class="breach-privacy-note">' +
        (LANG === 'ar'
          ? '✅ إيميلك آمن حالياً. واصل استخدام كلمات مرور قوية وفريدة مع تفعيل التحقق بخطوتين.'
          : '✅ Your email appears safe. Keep using strong, unique passwords with 2FA enabled on all accounts.') +
        '</div>';
    }

    // Scan again button
    html += '<div style="text-align:center">' +
      '<button class="breach-again-btn" onclick="document.getElementById(\'breachInput\').value=\'\';document.getElementById(\'breachInput\').focus();document.getElementById(\'breachResults\').style.display=\'none\';">' +
      '🔄 ' + (LANG==='ar'?'فحص إيميل آخر':'Check another email') +
      '</button></div>';

    res.innerHTML = html;

  } catch(e) {
    res.innerHTML = '<div class="breach-error">' +
      (LANG === 'ar' ? '⚠️ تعذّر الاتصال بخدمة فحص التسريبات.' : '⚠️ Could not connect to breach database.') +
      '<br><span style="font-size:0.65rem;color:var(--muted);margin-top:6px;display:inline-block">' +
      (LANG === 'ar' ? 'تحقق من اتصالك بالإنترنت وأعد المحاولة.' : 'Check your internet connection and try again.') +
      '</span></div>';
  }

  // Re-enable button
  if (scanBtn) { scanBtn.disabled = false; scanBtn.textContent = t('breach-scan'); }
}
...
function renderWeekComparison(){
  ...
  var SEV_COLORS = {Critical:'#ff3c5a',High:'#f5a623',Medium:'#ffd93d',Low:'#4cce8f'};
  var SEV_AR = {Critical:'حرج',High:'عالٍ',Medium:'متوسط',Low:'منخفض'};
  ...
  var sevGrid = SEVS.map(function(s){
    ...
    return '<div class="swc-sev-item">'+
      '<div class="swc-sev-name" style="color:'+SEV_COLORS[s]+'">'+sevName+'</div>'+
      '<div class="swc-sev-tw" style="color:'+SEV_COLORS[s]+'">'+tw+'</div>'+
      '<div class="swc-sev-lw">'+(LANG==='ar'?'الماضي':'last')+': '+lw+'</div>'+
      '<div class="swc-sev-delta" style="color:'+dCol+'">'+dStr+'</div>'+
    '</div>';
  }).join('');
  ...
  row.innerHTML =
    '<div class="swc-card">'+
      '<div class="swc-col">'+
        '<div class="swc-col-lbl">'+(LANG==='ar'?'هذا الأسبوع':'This Week')+'</div>'+
        '<div class="swc-col-num" style="color:var(--accent)">'+thisWeek.length+'</div>'+
        '<div class="swc-col-sub">'+(LANG==='ar'?'حادثة':'incidents')+'</div>'+
        '<div class="swc-delta-badge" style="background:'+deltaBg+';color:'+deltaColor+'">'+deltaStr+'</div>'+
      '</div>'+
      '<div class="swc-divider"></div>'+
      '<div class="swc-col">'+
        '<div class="swc-col-lbl">'+(LANG==='ar'?'الأسبوع الماضي':'Last Week')+'</div>'+
        '<div class="swc-col-num" style="color:var(--muted2)">'+lastWeek.length+'</div>'+
        '<div class="swc-col-sub">'+(LANG==='ar'?'حادثة':'incidents')+'</div>'+
      '</div>'+
      '<div class="swc-sev-grid" style="grid-column:1/-1">'+sevGrid+'</div>'+
    '</div>';
}
...
function init(){
  ...
  if (bsc) bsc.textContent = localStorage.getItem('breach_scan_count') || '0';
  applyLang();
...
var TOUR_STEPS = [
  {
    ...
    desc: {en:'ShieldKW is Kuwait\'s first community-driven cybersecurity awareness platform — built to protect you from digital scams, phishing, and data breaches. 9 powerful tools, all in one place, in Arabic and English.', ar:'ShieldKW هي أول منصة كويتية مجتمعية للتوعية بالأمن السيبراني — مبنية لتحميك من النصب الرقمي والتصيد وتسريبات البيانات. 9 أدوات قوية في مكان واحد، عربي وإنجليزي.'},
  ...
  },
  {
    ...
    heading: {en:'Community Threat Map', ar:'خريطة التهديدات المجتمعية'},
    desc: {en:'A live interactive map of cyber threats reported across all 6 Kuwait governorates. Filter by severity, toggle between pin and heatmap views, and see the live threat timeline. Every report comes from real Kuwaitis.', ar:'خريطة تفاعلية حية للتهديدات السيبرانية المبلّغ عنها في كل محافظات الكويت الـ6. فلتر حسب الخطورة، وتبدّل بين عرض الدبابيس والخريطة الحرارية، وشاهد الجدول الزمني الحي. كل بلاغ من كويتي حقيقي.'},
  ...
  },
  {
    ...
    desc: {en:'Chat with an AI assistant powered by Google Gemini. Paste any suspicious message, link, or email — the AI analyzes it, explains how the scam works, and tells you what to do. Ask follow-up questions to learn more.', ar:'تحدث مع مساعد ذكاء اصطناعي مدعوم بـ Google Gemini. الصق أي رسالة أو رابط أو إيميل مشبوه — الذكاء الاصطناعي يحلله ويشرح كيف النصبة تشتغل ويقولك شنو تسوي. اسأل أسئلة متابعة لمعرفة المزيد.'},
    tip: {en:'💡 Try the quick examples or paste any message you received that looks suspicious.', ar:'💡 جرّب الأمثلة السريعة أو الصق أي رسالة وصلتك وشكلها مشبوه.'},
  ...
  },
  {
    ...
    desc: {en:'An interactive quiz with 56 real-world Kuwaiti scam scenarios — SMS fraud, fake bank calls, WhatsApp account theft, investment scams, and more. Each session picks 20 random scenarios. After every answer, you get a detailed explanation of the scam tactic used.', ar:'اختبار تفاعلي مع 56 سيناريو احتيال كويتي حقيقي — نصب SMS ومكالمات بنوك مزيفة وسرقة حسابات واتساب واحتيالات استثمارية والمزيد. كل جلسة تختار 20 سيناريو عشوائي. بعد كل إجابة تحصل على شرح تفصيلي لأسلوب الاحتيال.'},
    tip: {en:'💡 Your personal best is saved locally. Can you score 20/20?', ar:'💡 أفضل نتيجة لك تُحفظ محلياً. هل تقدر تحصل على 20/20؟'},
  ...
  },
  {
    ...
    desc: {en:'34 curated cybersecurity articles covering NIST frameworks, Kuwait cyber law, banking security, AI scams, VPN safety, gaming threats, and more. Every article links to official sources — CISA, NIST, and Kuwait government sites. Track your reading progress too.', ar:'34 مقالة أمن سيبراني منتقاة تغطي أطر NIST والقانون السيبراني الكويتي وأمان البنوك واحتيالات الذكاء الاصطناعي وVPN وتهديدات الألعاب والمزيد. كل مقالة تربط بمصادر رسمية — CISA وNIST ومواقع الحكومة الكويتية. تابع تقدمك في القراءة أيضاً.'},
    tip: {en:'💡 Use the category filters + search to find exactly what you need.', ar:'💡 استخدم فلاتر الفئات والبحث للعثور على ما تريد بالضبط.'},
    color: '#00d4ff', color2: '#0055cc', glow: 'rgba(0,212,255,0.12)'
  },
  {
    icon: '🔐',
    tag: {en:'TAB 06', ar:'تبويب 06'},
    heading: {en:'Password Strength Checker', ar:'فاحص قوة كلمة المرور'},
    desc: {en:'A 13-point password analysis tool — checks length, complexity, common password lists, keyboard walk patterns, and queries the Have I Been Pwned database to check if your password appeared in any known breach. 100% client-side: your password never leaves your device.', ar:'أداة تحليل كلمة مرور من 13 نقطة — تفحص الطول والتعقيد وقوائم كلمات المرور الشائعة وأنماط لوحة المفاتيح وتستعلم من قاعدة Have I Been Pwned لمعرفة إذا تسرّبت كلمة مرورك. 100% محلي: كلمة مرورك لا تغادر جهازك أبداً.'},
    tip: {en:'💡 Use the "Generate Strong Password" button to get a cryptographically secure 20-character password instantly.', ar:'💡 استخدم زر "توليد كلمة مرور قوية" للحصول فوراً على كلمة مرور آمنة من 20 حرف.'},
    color: '#00ff88', color2: '#009944', glow: 'rgba(0,255,136,0.12)'
  },
  {
    icon: '🔗',
    tag: {en:'TAB 07', ar:'تبويب 07'},
    heading: {en:'Link & URL Scanner', ar:'فاحص الروابط والعناوين'},
    desc: {en:'Paste any suspicious URL and our scanner runs 10 instant local checks PLUS live queries to 5 cybersecurity APIs: VirusTotal (70+ antivirus engines), Google Safe Browsing, PhishTank, IPQualityScore, and URLScan.io. Full risk verdict in seconds.', ar:'الصق أي رابط مشبوه وفاحصنا يجري 10 فحوصات محلية فورية بالإضافة إلى استعلامات حية لـ5 APIs أمن سيبراني: VirusTotal (70+ محرك)، Google Safe Browsing، PhishTank، IPQualityScore، وURLScan.io. حكم خطر كامل في ثوانٍ.'},
    tip: {en:'💡 Always check unfamiliar links before clicking — especially ones sent in WhatsApp or SMS.', ar:'💡 دائماً افحص الروابط غير المألوفة قبل الضغط عليها — خاصةً المرسلة عبر واتساب أو SMS.'},
    color: '#f5a623', color2: '#cc6600', glow: 'rgba(245,166,35,0.12)'
  },
  {
    icon: '🛡️',
    ...
    desc: {en:'Enter your email address to check if it appeared in any known data breach. Powered by XposedOrNot — a free breach database covering 12 billion+ exposed records. If your email is found, you\'ll see exactly which sites were breached and what data was exposed.', ar:'أدخل إيميلك لمعرفة إذا ظهر في أي تسريب بيانات معروف. مدعوم بـ XposedOrNot — قاعدة بيانات مجانية تغطي أكثر من 12 مليار سجل مكشوف. إذا وُجد إيميلك، ستشوف بالضبط أي مواقع تعرّضت للاختراق وما البيانات التي انكشفت.'},
    tip: {en:'💡 Click any breach card to expand it and see the full details — exposed data types, domain, date, and description.', ar:'💡 اضغط على أي بطاقة تسريب لتوسيعها وترى التفاصيل الكاملة — أنواع البيانات المكشوفة والموقع والتاريخ والوصف.'},
    color: '#ff3c5a', color2: '#cc0033', glow: 'rgba(255,60,90,0.12)'
  },
  {
    icon: '🇰🇼',
    tag: {en:'BUILT FOR KUWAIT', ar:'مبني للكويت'},
    heading: {en:'Your Digital Shield — Always On', ar:'درعك الرقمي — دائماً جاهز'},
    desc: {en:'ShieldKW is built specifically for Kuwait — all scam scenarios, threat patterns, and knowledge base articles are tailored to the Kuwaiti digital landscape. Full Arabic (Kuwaiti dialect) and English support, RTL layout, and local threat intelligence.', ar:'ShieldKW مبنية خصيصاً للكويت — كل سيناريوهات الاحتيال وأنماط التهديد ومقالات قاعدة المعرفة مصمّمة للبيئة الرقمية الكويتية. دعم كامل للعربية الكويتية والإنجليزية وتخطيط RTL وذكاء تهديدات محلي.'},
    tip: {en:'💡 Stay safe out there. If something feels off — it probably is. 🇰🇼', ar:'💡 ابقَ بأمان. إذا شيء ما يحس وايد مشبوه — على الأغلب هو فعلاً كذا. 🇰🇼'},
...
function tourNav(dir) {
  ...
  if (tourCurrentStep >= TOUR_STEPS.length) { closeTour(); return; }
  renderTourStep();
}
...
function renderTourStep() {
  ...
  if (bar) bar.style.background = 'linear-gradient(90deg,' + color + ',' + color2 + ')';
  ...
  if (dotsEl) {
    ...
    for (var i = 0; i < total; i++) {
      ...
      (function(idx){ dot.onclick = function(){ tourCurrentStep = idx; renderTourStep(); }; })(i);
      dotsEl.appendChild(dot);
    }
    // Apply active color via inline style
    dotsEl.querySelectorAll('.td-active').forEach(function(d){ d.style.background = color; d.style.boxShadow = '0 0 8px ' + color; });
  }
  ...
  if (glowEl) glowEl.style.background = 'radial-gradient(ellipse at center, ' + glow + ' 0%, transparent 70%)';
...
if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',function(){init();checkFirstVisit();});}else{init();checkFirstVisit();}